...
function rt(e) {
  ...
  return a.addEventListener("pointerdown", c), a.addEventListener("pointerup", o), a.addEventListener("pointercancel", o), a.addEventListener("lostpointercapture", o), r.addEventListener("blur", o), () => {
    o(), a.removeEventListener("pointerdown", c), a.removeEventListener("pointerup", o), a.removeEventListener("pointercancel", o), a.removeEventListener("lostpointercapture", o), r.removeEventListener("blur", o);
  };
}
const st = "0.3.6", $e = (e) => typeof e == "string" && /^data:image\/(jpeg|png);base64,[A-Za-z0-9+/=]+$/.test(e), fe = {
  new: "Новый",
  active: "Активный",
...
const dt = (e) => JSON.stringify([
  ...
  e.equalProperty,
  e.includeHidden
]), ct = (e, t) => JSON.stringify([e, t].sort());
function pt(e, t, i) {
  ...
  for (const r of t.checks) {
    ...
    for (const n of [r.a, r.b]) {
      if (!n || n.manualOnly !== void 0 && typeof n.manualOnly != "boolean" || n.modelsMode !== void 0 && !["all", "selected"].includes(n.modelsMode) || n.presetId !== void 0 && typeof n.presetId != "string" || !["all", "any"].includes(n.mode) || ![n.models, n.include, n.exclude].every(
        (o) => Array.isArray(o) && o.every((c) => typeof c == "string")
    ...
    for (const n of r.results) {
      ...
      if (!n || typeof n.id != "string" || !Object.hasOwn(fe, n.state) || n.penetrationMm !== void 0 && (!Number.isFinite(n.penetrationMm) || n.penetrationMm < 0) || !Array.isArray(n.point) || n.point.length !== 3 || !n.point.every(Number.isFinite))
...
const D = (e, t) => [e[0] - t[0], e[1] - t[1], e[2] - t[2]], Se = (e, t, i = 1) => [
  e[0] + t[0] * i,
  e[1] + t[1] * i,
  e[2] + t[2] * i
], K = (e, t) => e[0] * t[0] + e[1] * t[1] + e[2] * t[2], Me = (e, t) => [
  e[1] * t[2] - e[2] * t[1],
  e[2] * t[0] - e[0] * t[2],
  e[0] * t[1] - e[1] * t[0]
], Q = (e) => Math.hypot(...e), ut = (e) => {
  const t = Q(e);
  return t > 1e-20 ? [e[0] / t, e[1] / t, e[2] / t] : void 0;
}, we = (e) => e.triangleCount ?? (e.indices ? e.indices.length / 3 : e.triangles.length / 9), ge = (e, t, i) => e.indices && e.vertices ? e.vertices[e.indices[t * 3 + Math.floor(i / 3)] * 3 + i % 3] : e.triangles[t * 9 + i], ve = (e, t) => [0, 3, 6].map((i) => [
  ge(e, t, i),
  ge(e, t, i + 1),
  ge(e, t, i + 2)
]);
...
const Oe = (e, t, i) => e.min.every((a, r) => a <= t.max[r] + i && e.max[r] >= t.min[r] - i);
function Re(e, t) {
  const i = {
    min: [1 / 0, 1 / 0, 1 / 0],
    max: [-1 / 0, -1 / 0, -1 / 0]
  ...
  for (const c of t)
    for (let u = 0; u < 9; u++) {
      const m = u % 3, h = ge(e, c, u);
      i.min[m] = Math.min(i.min[m], h), i.max[m] = Math.max(i.max[m], h);
    }
  if (t.length <= 12) return { ...i, ids: t };
  const a = i.max.map((c, u) => c - i.min[u]), r = a.indexOf(Math.max(...a)), n = (c) => ge(e, c, r) + ge(e, c, r + 3) + ge(e, c, r + 6);
  t.sort((c, u) => n(c) - n(u));
  const o = t.length >> 1;
  return {
    ...i,
    left: Re(e, t.slice(0, o)),
    right: Re(e, t.slice(o))
  };
}
function* Ee(e, t, i) {
  Oe(e, t, i) && (e.ids ? yield* e.ids : (yield* Ee(e.left, t, i), yield* Ee(e.right, t, i)));
}
function* me(e, t, i) {
  if (Oe(e, t, i)) {
    if (e.ids && t.ids) {
    ...
    if (e.ids) {
      yield* me(e, t.left, i), yield* me(e, t.right, i);
      return;
    }
    if (t.ids) {
      yield* me(e.left, t, i), yield* me(e.right, t, i);
      return;
    }
    yield* me(e.left, t.left, i), yield* me(e.left, t.right, i), yield* me(e.right, t.left, i), yield* me(e.right, t.right, i);
  }
}
function Ue(e, t) {
  const i = {
  ...
  for (const o of t)
    for (let c = 0; c < 3; c++)
      i.min[c] = Math.min(i.min[c], e[o].bounds.min[c]), i.max[c] = Math.max(i.max[c], e[o].bounds.max[c]);
  if (t.length <= 16) return { ...i, ids: t };
  const a = i.max.map((o, c) => o - i.min[c]), r = a.indexOf(Math.max(...a));
  t.sort(
    (o, c) => e[o].bounds.min[r] + e[o].bounds.max[r] - (e[c].bounds.min[r] + e[c].bounds.max[r])
  );
  const n = t.length >> 1;
  return {
    ...i,
    left: Ue(e, t.slice(0, n)),
    right: Ue(e, t.slice(n))
  };
}
function Fe(e, t, i, a) {
  const r = D(t, e), n = D(i[1], i[0]), o = D(i[2], i[0]), c = Me(r, o), u = K(n, c);
  if (Math.abs(u) <= 1e-12 * Q(r) * Q(n) * Q(o)) return;
  const m = 1 / u, h = D(e, i[0]), g = K(h, c) * m, w = Me(h, n), M = K(r, w) * m, j = K(o, w) * m, A = a / Math.max(Q(n), Q(o), a);
  if (g >= -A && M >= -A && g + M <= 1 + A && j >= -A && j <= 1 + A)
    return Se(e, r, Math.max(0, Math.min(1, j)));
}
function mt(e, t, i, a) {
  const r = i.map(Math.abs).indexOf(Math.max(...i.map(Math.abs))), n = [0, 1, 2].filter((u) => u !== r), o = (u, m, h) => (m[n[0]] - u[n[0]]) * (h[n[1]] - u[n[1]]) - (m[n[1]] - u[n[1]]) * (h[n[0]] - u[n[0]]), c = (u, m) => {
    const h = m.map((g, w) => o(g, m[(w + 1) % 3], u));
    return h.every((g) => g >= -a * Q(i)) || h.every((g) => g <= a * Q(i));
  };
  for (const u of e) if (c(u, t)) return u;
  for (const u of t) if (c(u, e)) return u;
  for (let u = 0; u < 3; u++)
    for (let m = 0; m < 3; m++) {
      const h = e[u], g = e[(u + 1) % 3], w = t[m], M = t[(m + 1) % 3], j = D(g, h), A = D(M, w), C = j[n[0]] * A[n[1]] - j[n[1]] * A[n[0]];
      if (Math.abs(C) < 1e-18) continue;
      const S = D(w, h), te = (S[n[0]] * A[n[1]] - S[n[1]] * A[n[0]]) / C, z = (S[n[0]] * j[n[1]] - S[n[1]] * j[n[0]]) / C;
      if (te >= 0 && te <= 1 && z >= 0 && z <= 1) return Se(h, j, te);
    }
}
function ft(e, t, i, a) {
  const r = Me(D(e[1], e[0]), D(e[2], e[0])), n = Me(D(t[1], t[0]), D(t[2], t[0])), o = Q(r), c = Q(n);
  if (o < 1e-20 || c < 1e-20) return;
  const u = t.map((h) => K(D(h, e[0]), r) / o), m = e.map((h) => K(D(h, t[0]), n) / c);
  if (!(u.every((h) => h > i) || u.every((h) => h < -i) || m.every((h) => h > i) || m.every((h) => h < -i))) {
    if (u.every((h) => Math.abs(h) <= i) && m.every((h) => Math.abs(h) <= i))
      return a ? mt(e, t, r, i) : void 0;
    if (!(!a && (!(Math.min(...u) < -i && Math.max(...u) > i) || !(Math.min(...m) < -i && Math.max(...m) > i))))
      for (let h = 0; h < 3; h++) {
        const g = Fe(e[h], e[(h + 1) % 3], t, i);
        if (g) return g;
        const w = Fe(t[h], t[(h + 1) % 3], e, i);
        if (w) return w;
      }
  }
}
function Qe(e, t) {
  const i = (a, r) => {
    const n = ut(Me(D(a[1], a[0]), D(a[2], a[0])));
    if (!n) return 1 / 0;
    const o = r.map((m) => K(D(m, a[0]), n)), c = Math.min(...o), u = Math.max(...o);
    return c < 0 && u > 0 ? Math.min(-c, u) : 0;
  };
  return Math.min(i(e, t), i(t, e));
}
function ht(e, t, i) {
  const a = D(t[1], t[0]), r = D(t[2], t[0]), n = Me(a, r), o = Q(n);
  if (o < 1e-20 || Math.abs(K(D(e, t[0]), n)) / o > i) return !1;
  const c = D(e, t[0]), u = K(a, a), m = K(a, r), h = K(r, r), g = K(c, a), w = K(c, r), M = u * h - m * m;
  if (Math.abs(M) < 1e-30) return !1;
  const j = (g * h - w * m) / M, A = (w * u - g * m) / M, C = i / Math.max(Q(a), Q(r), i);
  return j >= -C && A >= -C && j + A <= 1 + C;
}
function Ae(e, t, i, a) {
  if (!t.closed || e.some((g, w) => g <= t.bounds.min[w] + a || g >= t.bounds.max[w] - a))
    return !1;
  for (const g of Ee(i, { min: e, max: e }, a))
    if (ht(e, ve(t, g), a)) return !1;
  const r = [1, 0.371390676, 0.52999894], n = Q(D(t.bounds.max, t.bounds.min)) * 3 + 1, o = Se(e, r, n), c = [], u = De([...e, ...o]);
  for (const g of Ee(i, u, a)) {
    const w = Fe(e, o, ve(t, g), a);
    if (w) {
      const M = Q(D(w, e));
      M > a && c.push(M);
    }
...
function gt(e, t) {
  const i = D(t[1], t[0]), a = D(t[2], t[0]), r = D(e, t[0]), n = K(i, r), o = K(a, r);
  if (n <= 0 && o <= 0) return Q(r);
  const c = D(e, t[1]), u = K(i, c), m = K(a, c);
  if (u >= 0 && m <= u) return Q(c);
  if (n * m - u * o <= 0 && n >= 0 && u <= 0) {
    const S = n / (n - u);
    return Q(D(e, Se(t[0], i, S)));
  }
  const g = D(e, t[2]), w = K(i, g), M = K(a, g);
  if (M >= 0 && w <= M) return Q(g);
  if (w * o - n * M <= 0 && o >= 0 && M <= 0) {
    const S = o / (o - M);
    return Q(D(e, Se(t[0], a, S)));
  }
  if (u * M - w * m <= 0 && m - u >= 0 && w - M >= 0) {
    const S = D(t[2], t[1]), te = (m - u) / (m - u + (w - M));
    return Q(D(e, Se(t[1], S, te)));
  }
  const C = Me(i, a);
  return Math.abs(K(r, C)) / Math.max(Q(C), 1e-30);
}
function xt(e, t, i) {
  let a = 1 / 0;
  const r = (n) => {
    ...
    if (n.ids) {
      for (const u of n.ids)
        a = Math.min(a, gt(e, ve(t, u)));
      return;
    }
    const o = n.left, c = n.right;
    ze(e, o) < ze(e, c) ? (r(o), r(c)) : (r(c), r(o));
  };
  return r(i), a;
}
async function bt(e, t, i, a, r, n, o, c) {
  let u = n;
  const m = (g, w, M) => {
    Ae(g, w, M, o) && (u = Math.max(u, xt(g, w, M)));
  };
  m(r, e, i), m(r, t, a);
  let h = 0;
  for (const [g, w, M] of [
    ...
    for (let C = 0; C < j; C += A) {
      const S = ve(g, C), te = S[0].map((f, B) => (S[0][B] + S[1][B] + S[2][B]) / 3), z = S[0].map((f, B) => (S[0][B] + S[1][B]) / 2), Y = S[0].map((f, B) => (S[1][B] + S[2][B]) / 2), R = S[0].map((f, B) => (S[2][B] + S[0][B]) / 2);
      for (const f of [S[0], S[1], S[2], z, Y, R, te])
        m(f, w, M);
      h++ % 32 === 0 && await c();
    }
  }
...
async function yt(e, t, i, a, r) {
  const n = t.precision / 1e3;
  if (!Number.isFinite(n) || n <= 0)
    throw Error("Точность расчёта должна быть положительным числом.");
  const o = e.filter((k) => t.includeHidden || !k.hidden), c = o.filter((k) => je(k, t.a)), u = o.filter((k) => je(k, t.b));
  ...
  const h = async () => {
    ...
    for (let G = 0; G < we(k); G++)
      Z.push(
        [0, 3, 6].map(
          (pe) => [0, 1, 2].map((q) => Math.round(ge(k, G, pe + q) / n)).join(",")
        ).sort().join(";")
      ), G % 9e3 === 0 && await h();
    return $ = Z.sort().join("|"), M.set(k.id, $), $;
  }, A = [], C = new Set(c.map((k) => k.id)), S = new Set(u.map((k) => k.id)), te = Ue(
    u,
    u.map((k, $) => $)
  ), z = /* @__PURE__ */ new Map();
  let Y = 0;
  ...
  async function f(k, $) {
    ...
    for (const [G, pe] of z)
      G !== $ && Y > 96 * 1024 * 1024 && (z.delete(G), Y -= R(pe), g.delete(G), M.delete(G));
    return Z = await r(k.id), z.set(k.id, Z), Y += R(Z), Z;
  }
  let B = -1 / 0;
  for (let k = 0; k < c.length; k++) {
    ...
    const Z = [...Ee(te, $.bounds, n)];
    for (let G = 0; G < Z.length; G++) {
      const pe = Z[G];
      performance.now() - B > 150 && (B = performance.now(), i({
        phase: `Проверка пар · A ${k + 1}/${c.length} · кандидаты ${G + 1}/${Z.length}`,
        done: k,
        total: c.length,
        found: A.length
      }));
      const q = u[pe];
      if (await h(), $.id === q.id || !Oe($.bounds, q.bounds, n) || t.ignoreSameModel && $.modelId === q.modelId || t.ignoreSameGroup && $.modelId === q.modelId && $.properties.Объект && $.properties.Объект === q.properties.Объект || t.equalProperty && $.properties[t.equalProperty] !== void 0 && $.properties[t.equalProperty] === q.properties[t.equalProperty] || $.id > q.id && C.has(q.id) && S.has($.id)) continue;
      const he = ct($.id, q.id), E = await f($), L = await f(q, $.id);
      let U, V = "surface", J = 0;
      if (t.type === "duplicates") {
        if (we(E) !== we(L) || E.bounds.min.some(
          (T, N) => Math.abs(T - L.bounds.min[N]) > n || Math.abs(E.bounds.max[N] - L.bounds.max[N]) > n
        ))
          continue;
        await j(E) === await j(L) && (U = E.bounds.min.map((T, N) => (T + E.bounds.max[N]) / 2), V = "duplicate");
      } else {
        const T = w(E), N = w(L);
        let ee = 0, ce = 0;
        for (const [ae, le] of me(T, N, n)) {
          const re = ve(E, ae), ie = ve(L, le);
          if (!Oe(De(re.flat()), De(ie.flat()), n)) continue;
          const se = ft(re, ie, n, t.touching);
          if (se) {
            const ue = t.touching ? Qe(re, ie) : Math.max(Qe(re, ie), n);
            (!U || ue > ee) && (U = se), ee = Math.max(ee, ue);
          }
          ++ce % 256 === 0 && (performance.now() - B > 150 && (B = performance.now(), i({
            phase: `Геометрия пары · A ${k + 1}/${c.length}`,
            done: k,
            total: c.length,
            found: A.length
          })), await h());
        }
        if (!U && E.closed && L.closed) {
          const ae = E.bounds.min.map(
            (le, re) => (le + E.bounds.max[re]) / 2
          );
          Ae(ae, E, T, n) && Ae(ae, L, N, n) && (U = ae, V = "contained");
        }
        if (!U) {
          for (const [ae, le, re] of [
            [E, L, N],
            [L, E, T]
          ])
            if (le.closed) {
              for (let ie = 0; ie < we(ae) && !U; ie++) {
                const se = ve(ae, ie), ue = se[0].map(
                  (_, ne) => (se[0][ne] + se[1][ne] + se[2][ne]) / 3
                );
                for (const _ of [se[0], ue])
                  if (Ae(_, le, re, n)) {
                    U = _, V = "contained";
                    break;
                  }
        ...
        if (U && (J = await bt(
          ...
          n,
          h
        )), U && J + t.precision < t.minPenetration)
          continue;
      }
      if (U && (A.push({
        id: he,
  ...
  return JSON.stringify(
    {
      ...
      images: Object.fromEntries(
        t.filter((i) => $e(i.image)).map((i) => [i.id + ".jpg", i.image])
      ),
      warnings: e.warnings,
      tests: [
        {
...
const kt = "data:image/png;base64,", St = ":host{display:block;height:100%;color-scheme:dark;font:13px/1.4 Segoe UI,sans-serif;color:#dbe5f0;container-type:size}*{box-sizing:border-box}[hidden]{display:none!important}main{height:100%;min-height:260px;background:#171d25;display:flex;flex-direction:column;overflow:hidden;-webkit-user-select:none;user-select:none}button,input,select,textarea{font:inherit;color:inherit;border:1px solid #425165;border-radius:6px;background:#253140;padding:7px 9px;min-width:0}button{cursor:pointer;white-space:nowrap}button:hover{background:#354459}button:disabled{opacity:.45;cursor:default}.primary{background:#b99a38;border-color:#d0ae46;color:#111820;font-weight:600}.primary:hover{background:#e0bd51}button:focus-visible,input:focus-visible,select:focus-visible,textarea:focus-visible{outline:2px solid #f2c94c;outline-offset:1px}input,select,textarea{background:#111a24}input,textarea,td,dd{-webkit-user-select:text;user-select:text}input[type=checkbox]{accent-color:#e6c354;width:16px;height:16px}header{display:flex;gap:7px;align-items:center;padding:8px 12px;border-bottom:1px solid #354459;flex-shrink:0;overflow-x:auto}.brand{display:flex;gap:7px;align-items:center;margin-right:8px}.brand img{width:32px;height:32px;object-fit:contain}.brand b{font-size:17px}.brand small{font-size:10px;color:#a6b5c7}#dirty{margin-left:auto;font-size:11px;color:#cabb81;white-space:nowrap}.notice{background:#1c2735;padding:5px 12px;font-size:12px;min-height:27px;max-height:70px;overflow:auto;color:#a7bbd1}.notice.error{color:#ffaaa1;background:#412725}.workspace{display:grid;grid-template-columns:230px minmax(0,1fr);flex:1;min-height:0}aside{padding:10px;display:flex;flex-direction:column;gap:9px;border-right:1px solid #354459;min-height:0}#checks{overflow:auto;flex:1;min-height:0}.check-item{display:flex;flex-direction:column;gap:5px;width:100%;margin-bottom:5px;text-align:left;white-space:normal}.check-item small{color:#a8b7ca}.check-item.active,.tabs .active{border-color:#c7ab56;background:#403b2c;color:#ffe399}.main{display:flex;flex-direction:column;min-width:0;min-height:0}.test-toolbar{display:flex;gap:7px;padding:8px 12px;align-items:center}.test-toolbar input{flex:1;font-weight:600}.tabs{display:flex;gap:7px;border-bottom:1px solid #354459;padding:0 12px 8px}.tabs button{min-width:105px}#content{flex:1;min-height:0;overflow:auto;display:flex;flex-direction:column}.empty{padding:28px;color:#a4b4c9;text-align:center;margin:auto}h2,h3,p{margin:0 0 10px}h2{font-size:20px}h3{font-size:15px}label{display:flex;flex-direction:column;gap:5px;font-size:12px;color:#b8c6d7}.check{flex-direction:row;align-items:center;gap:6px}small{font-size:11px;color:#a8b7c9}.parameters{display:flex;gap:18px;align-items:end;padding:10px 12px}.parameters input{width:140px}.selection-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;padding:0 12px 12px}.selection{border:1px solid #39495e;border-radius:8px;padding:12px;background:#1b2633;min-width:0}.selection h3{display:flex;justify-content:space-between}.selection h3 span{color:#92c4b2;font-size:12px}.selection select[multiple]{width:100%;min-height:70px}.selection-tools{display:flex;gap:5px;flex-wrap:wrap;margin:8px 0}.selection-tools button{font-size:11px;padding:5px 7px}.selection>label{margin-bottom:8px}.condition{display:grid;grid-template-columns:minmax(80px,1fr) 100px minmax(70px,1fr) 29px;gap:5px;margin:6px 0}.condition button{padding:3px}.rules,.report{padding:18px;max-width:850px}.rules>label{margin:14px 0}.rules>p,.report>p{color:#a9b8cb}.report>button{margin:12px 8px 14px 0}.result-tools{display:flex;gap:7px;flex-wrap:wrap;padding:8px 12px}.result-tools input{flex:1;min-width:180px}.result-area{display:grid;grid-template-columns:minmax(0,1fr) 300px;flex:1;min-height:0}.table-area{display:flex;flex-direction:column;min-width:0;min-height:0}.scroll{overflow:auto;flex:1;min-height:0}table{border-collapse:separate;border-spacing:0;width:max-content;min-width:100%}th{position:sticky;top:0;background:#2a3748;z-index:1;text-align:left;max-width:240px;white-space:normal}th,td{padding:8px;border-bottom:1px solid #344154;vertical-align:top}td{max-width:320px;min-width:90px;overflow-wrap:anywhere;-webkit-user-select:text;user-select:text}td:first-child{min-width:36px}tr.active td{background:#453e29;color:#fff0b5}tr:hover td{background:#2c3847}.pager{display:flex;gap:10px;align-items:center;justify-content:center;padding:5px;border-top:1px solid #39495e;font-size:11px}.pager button{padding:2px 8px}.detail{border-left:1px solid #354459;padding:10px;overflow:auto}.detail h3{overflow-wrap:anywhere}.detail>label{margin:10px 0}.detail p{font:11px/1.5 Consolas,monospace}.detail details{border-top:1px solid #354459;padding:8px 0}summary{cursor:pointer}dl{font-size:11px;display:grid;grid-template-columns:1fr 1fr;gap:7px}dt,dd{overflow-wrap:anywhere;margin:0}dt{color:#9baec4}footer{border-top:1px solid #354459;padding:4px 12px;display:flex;justify-content:space-between;color:#91a4bb;font-size:11px}dialog{border:1px solid #53647c;border-radius:12px;background:#202c3a;color:#dbe5f0;width:min(700px,92vw);max-height:85vh;padding:20px;box-shadow:0 15px 60px #000a}dialog::backdrop{background:#000a}dialog p{margin:12px 0}dialog a{color:#f2c94c;margin-right:12px}.dialog-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}@container (max-width:950px){.workspace{grid-template-columns:185px minmax(0,1fr)}.result-area{grid-template-columns:minmax(0,1fr) 240px}.selection-grid{grid-template-columns:1fr}.parameters,.test-toolbar{flex-wrap:wrap}.test-toolbar input{flex-basis:100%}}@container (max-height:400px){header{padding:5px 10px}.test-toolbar{padding:5px 10px}.tabs{padding-bottom:5px}.brand img{width:25px;height:25px}footer{display:none}}:host{font-size:12px}.brand img{background:#e1e7ef;border-radius:5px;padding:3px}.selection-tools button{font-size:12px}label{font-size:13px}.choose-layout{display:grid;grid-template-columns:220px minmax(0,1fr);min-height:0;flex:1;overflow:auto}.choose-layout .parameters{display:flex;flex-direction:column;align-items:stretch;gap:15px;border-right:1px solid #354459;justify-content:flex-start}.choose-layout .parameters input{width:100%}.choose-layout .parameters input[type=checkbox]{width:16px}.choose-layout .selection-grid{padding:10px 12px;grid-template-columns:minmax(0,1fr) minmax(0,1fr);align-items:start;min-width:0}.selection select[multiple]{height:180px;resize:vertical}.selection-mode{font-size:12px;color:#b6c4d5}.preset-row{display:flex;flex-wrap:wrap;gap:5px;margin-bottom:9px}.preset-row select{flex:1 1 160px}.preset-row button{padding:5px 7px;font-size:12px}.model-list{height:150px;overflow:auto;border:1px solid #425165;border-radius:6px;background:#111a24;padding:5px;margin-bottom:5px}.model-list label{display:flex;flex-direction:row;align-items:center;gap:7px;padding:4px 5px;color:#dbe5f0;overflow-wrap:anywhere}.model-list label:hover{background:#253140}.model-list .model-all{position:sticky;top:-5px;z-index:1;background:#1f2b39;border-bottom:1px solid #425165;font-weight:600}.legend{display:flex;gap:12px;flex-wrap:wrap;font-family:inherit!important}.part-a{color:#ff6161}.part-b{color:#65baff}.preview{display:block;width:100%;padding:5px;margin:8px 0}.preview img{display:block;width:100%;max-height:180px;object-fit:contain}.image-dialog{width:94vw;max-width:1500px}.image-dialog img{display:block;max-width:100%;max-height:75vh;margin:10px auto}#help-dialog{width:min(1000px,94vw);line-height:1.6}#help-dialog details{padding:12px 0;border-bottom:1px solid #425165}#help-dialog summary{font-size:16px;font-weight:600;color:#f0d27a}#help-dialog li{margin:8px 0}@container (max-width:1100px){.choose-layout{grid-template-columns:180px minmax(0,1fr)}.choose-layout .selection-grid{grid-template-columns:1fr}.condition{grid-template-columns:minmax(60px,1fr) 100px minmax(60px,1fr) 29px}}@container (max-width:700px){.choose-layout{display:block}.choose-layout .parameters{border-right:0;border-bottom:1px solid #354459}.workspace{grid-template-columns:160px minmax(0,1fr)}}button,input,select,textarea{padding:5px 7px;border-radius:5px}button{min-height:27px}input[type=checkbox]{width:14px;height:14px}.commandbar{position:relative;display:flex;gap:8px;min-height:45px;padding:5px 8px;overflow:visible;background:#131b25}.brand{flex:0 0 auto;margin-right:0;gap:5px}.brand img{width:28px;height:28px}.brand b{font-size:14px}.check-heading{display:grid;grid-template-rows:25px 12px;flex:0 1 230px;min-width:145px}.check-heading input{height:25px;border:0;background:transparent;padding:2px 5px;font-weight:600}.check-heading small{padding:0 5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:9px}.tabs{align-self:stretch;align-items:center;flex:0 0 auto;gap:3px;padding:0;border:0}.tabs button{flex:0 0 auto;min-width:0;padding:5px 9px;background:transparent;border-color:transparent}.tabs .active{background:#3e3828;border-color:#b99a38}.header-actions{display:flex;align-items:center;gap:4px;margin-left:auto}#dirty{margin-left:0;width:0;height:0;overflow:visible;font-size:0}#dirty:not(:empty){width:7px;height:7px;border-radius:50%;background:#e5bd43;box-shadow:0 0 0 2px #e5bd4328}.more-menu{position:relative;z-index:20}.more-menu summary{display:grid;place-items:center;width:29px;height:29px;border:1px solid #425165;border-radius:5px;background:#253140;cursor:pointer;list-style:none;font-size:18px}.more-menu summary::-webkit-details-marker{display:none}.more-popover{position:absolute;right:0;top:calc(100% + 5px);display:grid;width:190px;gap:3px;padding:6px;border:1px solid #506176;border-radius:7px;background:#192431;box-shadow:0 12px 35px #000a}.more-popover button{text-align:left}.notice{min-height:23px;max-height:45px;padding:3px 9px;font-size:10px}.run-progress{display:grid;grid-template-columns:minmax(150px,auto) minmax(120px,1fr) auto;align-items:center;gap:8px;min-height:24px;padding:3px 9px;border-bottom:1px solid #425165;background:#202a20;color:#d9e7d2;font-size:10px}.run-bar{width:100%;height:7px;overflow:hidden;border-radius:2px;background:#101810}.run-bar i{display:block;width:0;height:100%;background:#e3bc43}#run-phase,#run-value{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}#run-value{text-align:right;color:#b9c9b3}.workspace{grid-template-columns:190px minmax(0,1fr)}aside{gap:6px;padding:7px;background:#141c26}.aside-title{font-weight:600;font-size:12px}.aside-actions{display:grid;gap:5px}.check-item{gap:2px;margin-bottom:3px;padding:6px 7px}.check-item small{font-size:9px}.main{background:#171d25}#content{overflow:hidden}.choose-layout{grid-template-columns:180px minmax(0,1fr)}.choose-layout .parameters{gap:9px;padding:8px}.choose-layout .selection-grid{gap:8px;padding:8px}.selection{padding:8px}.selection h3,h3{font-size:13px;margin-bottom:6px}label{gap:3px;font-size:11px}small,.selection-tools button,.preset-row button{font-size:10px}.model-list{height:125px}.model-list label{padding:2px 4px}.selection-tools{gap:4px;margin:5px 0}.selection-tools button,.preset-row button{padding:3px 5px;min-height:23px}.result-tools{display:flex;align-items:center;justify-content:space-between;gap:6px;flex-wrap:nowrap;min-height:38px;padding:5px 7px;border-bottom:1px solid #354459;background:#151f2a}.result-filters,.bulk-tools{display:flex;align-items:center;gap:5px;min-width:0}.result-filters{flex:1}.result-filters input[type=search]{flex:1 1 190px;min-width:120px}#result-depth{flex:0 1 125px;min-width:92px}#result-count,#selection-count{color:#9fb0c4;white-space:nowrap;font-size:10px}.bulk-tools select{max-width:125px}.result-area{grid-template-columns:minmax(0,1fr) 310px}th,td{padding:5px 6px;font-size:11px;line-height:1.25}th{max-width:190px}td{max-width:260px;min-width:76px}.pager{justify-content:flex-end;min-height:29px;padding:3px 7px}.pager #selection-count{margin-right:auto}.detail{display:flex;flex-direction:column;min-width:0;padding:0;overflow:hidden;background:#141e29}.detail-head{display:flex;align-items:center;justify-content:space-between;gap:6px;min-height:47px;padding:7px 8px 4px}.detail-head>div:first-child{min-width:0}.detail-head small{color:#8093aa;letter-spacing:.08em}.detail-head h3{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin:0}.detail-nav{display:flex;gap:3px}.detail-nav button{min-width:27px;padding:2px 7px;font-size:17px}.clash-summary{display:flex;gap:5px;padding:0 8px 5px;color:#adbdcf;font-size:9px}.clash-summary span{padding-right:5px;border-right:1px solid #405064}.clash-summary span:last-child{border:0}.detail .legend{margin:0;padding:0 8px 5px;font-size:10px}.preview-slot{height:clamp(92px,18cqh,145px);flex:0 0 auto;margin:0 7px 6px;overflow:hidden;border:1px solid #37475b;border-radius:6px;background:#0e151d}.preview{position:relative;width:100%;height:100%;margin:0;padding:0;border:0;background:transparent}.preview img{width:100%;height:100%;max-height:none;object-fit:contain}.preview span{position:absolute;right:5px;bottom:5px;padding:3px 6px;border-radius:4px;background:#101923db;font-size:9px}.preview-empty,.detail-empty{height:100%;display:grid;place-content:center;justify-items:center;gap:4px;color:#788ba1}.preview-empty>span,.detail-empty>span{font-size:24px}.detail-actions{display:grid;grid-template-columns:1fr 1fr;gap:5px;padding:0 7px 7px}.detail-scroll{flex:1;min-height:0;overflow:auto;padding:7px 8px 12px;border-top:1px solid #354459}.detail-scroll>label{margin:7px 0}.detail p{font:inherit}.coordinates{display:grid;grid-template-columns:repeat(3,1fr);gap:3px;font:9px/1.3 Consolas,monospace;color:#91a3b7}.coordinates span{overflow:hidden;text-overflow:ellipsis}.detail details{padding:6px 0}.detail dl{font-size:10px}.detail-empty{padding:20px;text-align:center}footer{padding:2px 8px;font-size:9px}@container (max-width:1050px){.workspace{grid-template-columns:165px minmax(0,1fr)}.result-area{grid-template-columns:minmax(0,1fr) 270px}.check-heading{flex-basis:185px}.tabs button{padding-inline:6px}#dirty{display:none}}@container (max-width:820px){.brand b,.brand small,#result-count{display:none}.check-heading{flex-basis:155px}.result-tools{overflow-x:auto}.result-area{grid-template-columns:minmax(0,1fr) 245px}}@container (max-height:410px){.notice,footer{display:none}.preview-slot{height:90px}}", ye = /* @__PURE__ */ new WeakMap(), it = "nashepo.collisionfinder360.project.", Ne = () => ({
  ...
  if (!(!e || typeof sessionStorage > "u"))
    try {
      const t = sessionStorage.getItem(it + e);
...
function It(e, t) {
  const i = e.shadowRoot || e.attachShadow({ mode: "open" }), a = rt(e);
  let r = t.projectToken(), n = t.projectId(), o = r && (ye.get(r) || He(n)) || Ne();
  r && ye.set(r, o);
  let c, u = o.checks[0]?.id || "", m = "select", h = "", g = 0, w = !1, M = !1, j, A = !0, C = !1;
  const S = /* @__PURE__ */ new Set();
  let te, z, Y = 0;
  const R = () => o.checks.find((s) => s.id === u), f = (s) => i.querySelector("#" + s);
  i.innerHTML = `<style>${St}</style><main><header class="commandbar"><div class="brand"><img src="${kt}" alt=""><b>НашеПО</b><small>${st}</small></div><div class="check-heading"><input id="name" aria-label="Имя проверки" placeholder="Выберите проверку"><small id="check-summary">Проверка не выбрана</small></div><div id="tabs" class="tabs">${[
    ["select", "Выбор"],
    ["results", "Результаты"],
    ["rules", "Правила"],
    ["report", "Отчёт"]
  ...
  B.id = "clear-project", B.textContent = "Очистить проект", f("save").after(B), i.querySelector(".more-popover").addEventListener(
    "click",
    () => i.querySelector(".more-menu").removeAttribute("open")
  );
  const k = (s, l = !1) => {
    f("notice").textContent = s, f("notice").classList.toggle("error", l);
  }, $ = (s, l, d, p) => {
    const x = f("run-progress"), v = f("run-bar"), b = f("run-fill");
    if (x.hidden = !1, f("notice").hidden = !0, f("run-phase").textContent = s, d && d > 0 && l !== void 0) {
      const y = Math.max(0, Math.min(100, l / d * 100));
      b.style.width = `${y}%`, v.setAttribute("aria-valuemin", "0"), v.setAttribute("aria-valuemax", "100"), v.setAttribute("aria-valuenow", String(Math.round(y))), f("run-value").textContent = `${Math.round(y)}% · ${l}/${d}` + (p === void 0 ? "" : ` · найдено ${p}`);
    } else
      b.style.width = "0", v.removeAttribute("aria-valuenow"), f("run-value").textContent = p === void 0 ? "" : `Найдено ${p}`;
    v.setAttribute("aria-valuetext", f("run-value").textContent || s);
  }, Z = () => {
    f("run-progress").hidden = !0, f("notice").hidden = !1;
  }, G = async (s) => {
    try {
      await s();
    } catch (l) {
    ...
    const l = f("set-dialog"), d = f("set-name");
    let p = !1;
    const x = (v) => {
      p || (p = !0, l.close(), s(v));
    };
    d.value = "Новый набор", f("set-confirm").onclick = () => {
      const v = d.value.trim();
      v ? x(v) : d.focus();
    }, f("set-cancel").onclick = () => x(), l.oncancel = (v) => {
      v.preventDefault(), x();
    }, l.showModal(), d.focus(), d.select();
  }), q = () => {
    C = !0, f("dirty").textContent = "Есть несохранённые изменения", r && ye.set(r, o), Je(n, o);
  }, he = () => {
    const s = t.projectToken();
    return !s || s === r ? !1 : (!r && (o.checks.length || o.sets.length) ? ye.set(s, o) : o = ye.get(s) || He(t.projectId()) || Ne(), ye.set(s, o), r = s, n = t.projectId(), c = void 0, u = o.checks[0]?.id || "", h = "", S.clear(), g = 0, C = !1, t.clear(), f("dirty").textContent = "", !0);
  }, E = () => {
    const s = R();
    s?.lastRun && (s.status = "stale"), q(), J();
  }, L = () => [
    ...new Set(
      (c?.elements || []).flatMap((s) => Object.keys(s.properties))
    )
  ].sort(), U = (s, l) => s.map(
    (d) => `<option value="${H(d)}" ${d === l ? "selected" : ""}>${H(d)}</option>`
  ).join("");
  function V() {
    const s = R(), l = f("result-search")?.value.toLowerCase() || "", d = f("result-state")?.value || "", p = Number(f("result-depth")?.value || 0);
    return (s?.results || []).filter(
      (x) => (!d || x.state === d) && (s?.type === "duplicates" || (x.penetrationMm ?? 0) >= p) && (!l || JSON.stringify({ ...x, image: void 0 }).toLowerCase().includes(l))
    );
  }
  function J() {
    const s = f("test-search").value.toLowerCase();
    f("checks").innerHTML = o.checks.filter((l) => l.name.toLowerCase().includes(s)).map(
      (l) => `<button class="check-item ${l.id === u ? "active" : ""}" data-check="${l.id}"><strong>${H(l.name)}</strong><small>${{ new: "Не выполнена", done: "Выполнена", stale: "Устарела" }[l.status]} · ${l.results.filter((d) => !["resolved", "excluded"].includes(d.state)).length} в работе / ${l.results.length}</small></button>`
    ).join("");
  }
  function T(s, l) {
    const d = c?.elements.filter(
      (I) => (R().includeHidden || !I.hidden) && je(I, s)
    ).length || 0, p = s.manualOnly ? ae(s) : s.modelsMode === "selected" ? s.models : (c?.models || []).map((I) => I.id), x = c && p.every((I) => c.indexedModelIds.includes(I)) ? `${d} элементов` : "число после запуска", v = c?.models || [], b = s.modelsMode !== "selected", y = o.sets.map(
      (I) => `<option value="${H(I.id)}" ${s.presetId === I.id ? "selected" : ""}>${H(I.name)}</option>`
    ).join("");
    return `<article class="selection" data-side="${l}"><h3>Выбор ${l.toUpperCase()} <span data-selection-count>${x}</span></h3>${s.manualOnly ? '<p class="selection-mode">Только элементы, выбранные вручную</p>' : ""}<div class="preset-row"><select class="preset"><option value="">Набор моделей…</option>${y}</select><button data-selection="load-set">Применить</button><button data-selection="save-set">Сохранить набор</button><button data-selection="delete-set" ${s.presetId ? "" : "disabled"}>Удалить</button></div><div class="model-list"><label class="model-all"><input type="checkbox" class="all-models" ${b ? "checked" : ""}> Все модели</label>${v.map((I) => `<label><input type="checkbox" class="model-check" value="${H(I.id)}" ${b || s.models.includes(I.id) ? "checked" : ""}> ${H(I.name)}</label>`).join("") || "<small>Нажмите «Модели».</small>"}</div><small>Отметьте файлы, которые должны участвовать в выборе ${l.toUpperCase()}.</small><div class="selection-tools"><button data-selection="show">Показать выбранные элементы</button><button data-selection="only">Только выделенные в 3D</button><button data-selection="include">＋ Добавить из 3D</button><button data-selection="exclude">− Исключить из 3D</button><button data-selection="reset">Сбросить ручной выбор</button></div><small>Добавлено вручную: ${s.include.length} · исключено: ${s.exclude.length}</small></article>`;
  }
  function N() {
    J();
    const s = R();
    f("name").value = s?.name || "", f("check-summary").textContent = s ? `${{ new: "Не выполнена", done: "Выполнена", stale: "Устарела" }[s.status]} · ${s.results.filter((l) => !["resolved", "excluded"].includes(l.state)).length} в работе / ${s.results.length}` : "Проверка не выбрана";
    ...
    m === "select" && (f("content").innerHTML = `<div class="choose-layout"><div class="parameters"><h3>Параметры проверки</h3><label>Тип<select id="type"><option value="intersection" ${s.type === "intersection" ? "selected" : ""}>По пересечению</option><option value="duplicates" ${s.type === "duplicates" ? "selected" : ""}>Дублирование</option></select></label><label title="Числовая погрешность расчёта">Точность расчёта, мм<input id="precision" type="number" value="${s.precision}" min="0.001" max="100" step="0.1"></label><label title="Конфликты с меньшей оценкой глубины не попадут в результат">Минимальная глубина, мм<input id="min-penetration" type="number" value="${s.minPenetration}" min="0" max="100000" step="1" ${s.type === "duplicates" ? "disabled" : ""}></label><label class="check"><input id="touching" type="checkbox" ${s.touching ? "checked" : ""} ${s.type === "duplicates" ? "disabled" : ""}>Учитывать касания</label><small>Глубина Hard Clash считается по фактическим пересечениям треугольников и вложенности замкнутых тел. Габариты используются только для быстрого отбора пар.</small><p class="legend"><span class="part-a">● Выбор А</span><span class="part-b">● Выбор Б</span></p></div><div class="selection-grid">${T(s.a, "a")}${T(s.b, "b")}</div></div><datalist id="property-fields">${U(L(), "")}</datalist>`), m === "rules" && (f("content").innerHTML = `<div class="rules"><h3>Исключение пар</h3><p>Элемент сам с собой не проверяется. Пара А/Б учитывается один раз.</p><label class="check"><input id="same-model" type="checkbox" ${s.ignoreSameModel ? "checked" : ""}>Не проверять элементы одной модели</label><label class="check"><input id="same-group" type="checkbox" ${s.ignoreSameGroup ? "checked" : ""}>Не проверять геометрию одного составного объекта</label><label>Не проверять пары с одинаковым значением свойства<input id="equal-property" list="property-fields" value="${H(s.equalProperty)}" placeholder="Без ограничения"></label><label class="check"><input id="hidden" type="checkbox" ${s.includeHidden ? "checked" : ""}>Включать скрытые элементы прочитанных моделей</label><p>Незагруженные подключённые файлы нужно открыть перед расчётом.</p><datalist id="property-fields">${U(L(), "")}</datalist></div>`), m === "results" && (f("content").innerHTML = `<div class="result-tools"><div class="result-filters"><input id="result-search" type="search" placeholder="Поиск по результатам"><select id="result-state"><option value="">Все состояния</option>${Object.entries(
      fe
      ...
      fe
    ).map(([l, d]) => `<option value="${l}">${d}</option>`).join("")}</select><button id="bulk">Применить</button></div></div><div class="result-area"><div class="table-area"><div class="scroll" id="table"></div><div class="pager"><span id="selection-count"></span><button id="prev-page">←</button><span id="page"></span><button id="next-page">→</button></div></div><div class="detail" id="detail"></div></div>`, ee(), ce()), m === "report" && (f("content").innerHTML = `<div class="report"><h3>${H(s.name)}</h3><p>Результатов: ${s.results.length}. Выбрано: ${S.size}. ${s.status === "stale" ? "Результаты устарели — рекомендуется повторный запуск." : ""}</p><label class="check"><input id="selected-only" type="checkbox" ${S.size ? "checked" : ""}>Только выбранные строки</label><label class="check"><input id="report-images" type="checkbox" checked>Добавить снимки (недостающие будут созданы автоматически)</label><button id="export-html" class="primary">Сформировать HTML-отчёт</button><button id="export-viewer">Сессия для плагина «Коллизии»</button><p>Правила и все результаты сохраняются кнопкой «Сохранить проверки» в верхней панели.</p></div>`), f("content").inert = w;
  }
  function ee() {
    const s = R(), l = V(), d = Math.max(1, Math.ceil(l.length / 50));
    g = Math.max(0, Math.min(g, d - 1));
    const p = l.slice(g * 50, g * 50 + 50);
    f("table").innerHTML = l.length ? `<table><thead><tr><th><input id="check-page" type="checkbox" aria-label="Выбрать страницу" ${p.every((x) => S.has(x.id)) ? "checked" : ""}></th>${["№", "Состояние", "Глубина, мм", "Элемент А", "Модель А", "GUID А", "Элемент Б", "Модель Б", "GUID Б", "Комментарий"].map((x) => `<th>${x}</th>`).join("")}</tr></thead><tbody>${p.map((x, v) => `<tr data-result="${H(x.id)}" class="${x.id === h ? "active" : ""}"><td><input type="checkbox" class="row-check" aria-label="Выбрать конфликт" ${S.has(x.id) ? "checked" : ""}></td>${[g * 50 + v + 1, fe[x.state], s.type === "duplicates" ? "—" : (x.penetrationMm ?? 0).toFixed(1), x.a.name, x.a.model, x.a.guid || "—", x.b.name, x.b.model, x.b.guid || "—", x.note].map((b) => `<td title="${H(b)}">${H(b)}</td>`).join("")}</tr>`).join("")}</tbody></table>` : '<div class="empty">Нет результатов. Запустите проверку или измените фильтры.</div>', f("page").textContent = `${g + 1} / ${d}`, f("result-count").textContent = `${l.length} результатов`, f("selection-count").textContent = `Выбрано: ${S.size}`, f("prev-page").disabled = g === 0, f("next-page").disabled = g === d - 1;
  }
  function ce() {
    const s = R(), l = V(), d = l.findIndex((x) => x.id === h), p = s?.results.find((x) => x.id === h);
    f("detail").innerHTML = p ? `<div class="detail-head"><div><small>КОЛЛИЗИЯ</small><h3>#${d + 1} ${H(p.a.name)} × ${H(p.b.name)}</h3></div><div class="detail-nav"><button id="previous" title="Предыдущая коллизия" ${d <= 0 ? "disabled" : ""}>‹</button><button id="next" title="Следующая коллизия" ${d < 0 || d >= l.length - 1 ? "disabled" : ""}>›</button></div></div><div class="clash-summary"><span>${s?.type === "duplicates" ? "Дублирование" : "Пересечение"}</span><span title="Максимальная локальная глубина по пересекающимся парам треугольников и вложенным поверхностям">${s?.type === "duplicates" ? "Совпадение геометрии" : `Глубина ${(p.penetrationMm ?? 0).toFixed(1)} мм`}</span><span>${H(fe[p.state])}</span></div><p class="legend"><span class="part-a">● Элемент А</span><span class="part-b">● Элемент Б</span></p><div class="preview-slot">${p.image ? `<button id="open-image" class="preview"><img src="${H(p.image)}" alt="Снимок коллизии"><span>Открыть крупнее</span></button>` : '<div class="preview-empty"><span>◫</span><small>Снимок создастся после перехода в 3D</small></div>'}</div><div class="detail-actions"><button id="focus" class="primary">Перейти в 3D</button><button id="capture-image">▣ Снимок пары</button></div><div class="detail-scroll"><div class="coordinates">${p.point.map((x, v) => `<span>${["X", "Y", "Z"][v]} ${x.toFixed(3)}</span>`).join("")}</div><label>Состояние<select id="edit-state">${Object.entries(
      fe
    ).map(
  ...
  const ae = (s) => {
    ...
    for (const d of s.include)
      try {
        l.add(String(JSON.parse(d)[0]));
      } catch {
        const p = c?.elements.find(
          (x) => x.id === d
        )?.modelId;
        p && l.add(p);
      }
    ...
    if (!(!s || m !== "select"))
      for (const l of i.querySelectorAll("[data-side]")) {
        const d = l.dataset.side, p = [...l.querySelectorAll(".model-check")];
        if (!p.length) continue;
        const x = p.filter((y) => y.checked).map((y) => y.value), v = x.length === p.length, b = s[d];
    ...
    const l = new Set(s.map((y) => y.id)), d = s.map((y) => ({
      id: y.id,
      ...
      if (l.has(y)) return y;
      const I = ie(y), O = d.filter(
        (P) => [...I].some((X) => P.aliases.has(X))
      );
      ...
      try {
        ...
        const O = String(I[0]), P = p(O);
        return P === O ? y : JSON.stringify([P, ...I.slice(1)]);
      } catch {
        return y;
      }
    };
    let v = !1;
    const b = (y) => {
      const I = y.models.map(p), O = y.include.map(x), P = y.exclude.map(x);
      (I.some((X, be) => X !== y.models[be]) || O.some((X, be) => X !== y.include[be]) || P.some((X, be) => X !== y.exclude[be])) && (y.models = [...new Set(I)], y.include = [...new Set(O)], y.exclude = [...new Set(P)], v = !0);
    };
    ...
    for (const y of o.sets) {
      ...
      I.some((O, P) => O !== y.selection.models[P]) && (y.selection.models = [...new Set(I)], v = !0);
    }
    return v && q(), v;
  }, ue = () => {
    const s = R();
    if (s)
      for (const l of i.querySelectorAll("[data-side]")) {
        const d = l.dataset.side, p = c?.elements.filter(
          (y) => (s.includeHidden || !y.hidden) && je(y, s[d])
        ).length || 0, x = s[d].manualOnly ? ae(s[d]) : s[d].modelsMode === "selected" ? s[d].models : (c?.models || []).map((y) => y.id), v = !!c && x.every((y) => c.indexedModelIds.includes(y)), b = l.querySelector(
  ...
  function ne(s, l = !1) {
    if (!w) {
      if (h = s, m === "results") {
        const d = V().findIndex((x) => x.id === s), p = d < 0 ? g : Math.floor(d / 50);
        p !== g && (g = p, ee());
      ...
      if (_(), l) {
        const d = R()?.results.find((p) => p.id === s);
        d && (t.focus(d, Number(f("distance").value)), W(d));
      }
    }
  }
  function W(s) {
    clearTimeout(z);
    const l = ++Y;
    s.image && s.imageScope === "pair-ab" || !t.canLocate(s) || (z = window.setTimeout(async () => {
      if (!(l !== Y || w || h !== s.id))
        try {
          const d = await t.snapshot(
            s,
          ...
          if (l !== Y || h !== s.id) return;
          s.image = d, s.imageScope = "pair-ab", q(), m === "results" && ce();
        } catch (d) {
          l === Y && h === s.id && k(
  ...
  async function Ie(s) {
    ...
    try {
      s.image = await t.snapshot(
        ...
        Number(f("distance").value),
        () => M
      ), s.imageScope = "pair-ab", q(), m === "results" && h === s.id && ce();
    } catch (l) {
      k(
  ...
  async function ke(s, l = !1) {
    he(), $("Подготовка моделей");
    let d = l ? /* @__PURE__ */ new Set() : re(s);
    if (!l && d?.size) {
      const p = await t.scan(
        (x) => $(x),
        () => M,
        /* @__PURE__ */ new Set()
      );
      c = p, se(p.models) && (d = re(s));
    }
    c = await t.scan(
      (p) => {
        k(p), $(p);
      ...
      () => M,
      d
    ), f("model-count").textContent = `Проиндексировано моделей: ${c.indexedModelIds.length} из ${c.models.length} · элементов: ${c.elements.length}`, N(), k(
  ...
  async function de(s) {
    ...
    return j = d, new Promise((p, x) => {
      const v = () => {
        d.terminate(), j = void 0, te = void 0;
      };
      te = () => {
  ...
  async function oe(s = !1) {
    if (w) return;
    he(), le();
    const l = s ? [...o.checks] : [R()].filter(Boolean);
    ...
    try {
      if (await ke(l), F(!0), c.blockers.length)
        throw Error(
      ...
      for (const p of l) {
        ...
        for (const y of [p.a, p.b]) {
          if (y.modelsMode === "selected" && y.models.some((I) => !c.models.some((O) => O.id === I)))
            throw Error(
              `${p.name}: одна из моделей выборки отсутствует. Исправьте выборку.`
            );
          if (y.include.some((I) => !c.elements.some((O) => O.id === I)))
            throw Error(
        ...
        p.results = pt(
          ...
          v,
          b
        ), p.lastRun = b, p.fingerprint = c.fingerprint, p.configAtRun = x, p.modelsAtRun = [...c.indexedModelIds], p.status = "done", p.warnings = [...c.warnings], u = p.id, h = p.results[0]?.id || "", S.clear(), q();
      }
      m = "results", N(), _(), k(
        `Проверка завершена. ${R()?.results.length || 0} результатов. Сохраните проверки для продолжения работы.`
      );
      const d = R()?.results.find((p) => p.id === h);
      d && !M && await Ie(d);
    } finally {
      Z(), F(!1), N();
    }
  ...
  function xe(s) {
    ...
    if (!l) return;
    const d = R()[l], p = s, x = s.closest("[data-side]");
  ...
  f("new").onclick = () => {
    const s = lt();
    s.name = `Проверка ${o.checks.length + 1}`, o.checks.push(s), u = s.id, m = "select", h = "", S.clear(), q(), N();
  }, f("scan").onclick = () => G(async () => {
    le(), M = !1, F(!0), $("Чтение моделей");
    try {
      const s = R();
      await ke(s ? [s] : void 0, !s);
    } finally {
      Z(), F(!1), N();
    }
  }), f("run").onclick = () => G(() => oe()), f("all").onclick = () => G(() => oe(!0)), f("cancel").onclick = () => {
    M = !0, te?.();
  }, f("test-search").oninput = J, f("checks").onclick = (s) => {
    const l = s.target.closest(
      "[data-check]"
    );
    l && !w && (t.clear(), u = l.dataset.check, h = "", S.clear(), g = 0, N());
  }, f("tabs").onclick = (s) => {
    const l = s.target.closest("[data-tab]");
    l && !w && (m = l.dataset.tab, N());
  }, f("name").onchange = () => {
    const s = R();
    s && (s.name = f("name").value.trim() || "Проверка", q(), J());
  }, f("copy").onclick = () => {
    const s = R();
    if (!s) return;
    ...
    Object.assign(l, {
      ...
      configAtRun: void 0,
      status: "new"
    }), o.checks.push(l), u = l.id, h = "", S.clear(), q(), N();
  }, f("delete").onclick = () => {
    R() && confirm(`Удалить проверку «${R().name}» и её результаты?`) && (o.checks = o.checks.filter((s) => s.id !== u), u = o.checks[0]?.id || "", S.clear(), t.clear(), q(), N());
    ...
    ) && (o.checks = [], o.sets = [], c = void 0, u = "", h = "", S.clear(), t.clear(), q(), f("model-count").textContent = "Модели не прочитаны", N(), k("Данные проверок текущего проекта очищены."));
  }, f("save").onclick = () => {
    Te("НашеПО-проверки.json", JSON.stringify(o, null, 2)), C = !1, f("dirty").textContent = "Файл проверок сохранён";
  }, f("open").onclick = () => f("file").click(), f("file").onchange = () => G(async () => {
    const s = f("file").files?.[0];
    if (!s) return;
    const l = et(await s.text());
    C && !confirm("Заменить текущие несохранённые проверки данными из файла?") || (o = l, r && ye.set(r, o), Je(n, o), u = o.checks[0]?.id || "", h = "", S.clear(), t.clear(), C = !1, f("dirty").textContent = "Проверки открыты", N(), k("Проверки открыты. Обновите модели перед переходом к элементам."), f("file").value = "");
  });
  ...
  f("content").onchange = (s) => G(() => {
    const l = s.target, d = R();
    if (!d) return;
    ...
    if ([
      ...
      l.id === "type" && (d.type = l.value), l.id === "touching" && (d.touching = l.checked), l.id === "same-model" && (d.ignoreSameModel = l.checked), l.id === "same-group" && (d.ignoreSameGroup = l.checked), l.id === "hidden" && (d.includeHidden = l.checked), l.id === "equal-property" && (d.equalProperty = l.value), E(), N();
      return;
    }
    ...
    if (l.classList.contains("row-check")) {
      ...
      l.checked ? S.add(x) : S.delete(x), f("selection-count").textContent = `Выбрано: ${S.size}`;
      return;
    }
    const p = d.results.find((x) => x.id === h);
    p && (l.id === "edit-state" && (p.state = l.value, ee(), J(), _()), l.id === "assignee" && (p.assignee = l.value), l.id === "note" && (p.note = l.value, ee()), q());
  }), f("content").oninput = (s) => {
    const l = s.target;
    (l.id === "result-search" || l.id === "result-depth") && (g = 0, ee());
    const d = R(), p = Number(l.value);
    d && l.id === "precision" && Number.isFinite(p) && p >= 1e-3 && p <= 100 && (d.precision = p, E()), d && l.id === "min-penetration" && Number.isFinite(p) && p >= 0 && p <= 1e5 && (d.minPenetration = p, E());
  }, f("content").onclick = (s) => G(async () => {
    const l = s.target, d = l.closest("button"), p = R();
    if (!p) return;
    if (d?.dataset.selection) {
      const v = d.closest("[data-side]").dataset.side, b = p[v], y = f("content").scrollTop;
      let I = !0;
      switch (d.dataset.selection) {
        case "load-set": {
          const O = o.sets.find((P) => P.id === b.presetId);
        ...
        case "save-set": {
          ...
          o.sets.push(P), b.presetId = P.id, I = !1;
          break;
        }
        case "delete-set": {
          const O = o.sets.find((P) => P.id === b.presetId);
          ...
          o.sets = o.sets.filter((P) => P.id !== O.id);
          for (const P of o.checks)
            for (const X of [P.a, P.b])
              X.presetId === O.id && (X.presetId = void 0);
          I = !1;
          break;
        }
        case "show":
          t.select(
            (c?.elements || []).filter((O) => (p.includeHidden || !O.hidden) && je(O, b)).map((O) => O.id)
          );
          return;
        case "only": {
          const O = t.selected();
        ...
        case "include": {
          const O = t.selected();
          if (!O.length) throw Error("Выделите элементы в 3D-сцене.");
          b.include = [.../* @__PURE__ */ new Set([...b.include, ...O])], b.exclude = b.exclude.filter((P) => !O.includes(P));
          break;
        }
        case "exclude": {
          const O = t.selected();
          if (!O.length) throw Error("Выделите элементы в 3D-сцене.");
          b.exclude = [.../* @__PURE__ */ new Set([...b.exclude, ...O])], b.include = b.include.filter((P) => !O.includes(P));
          break;
        }
        case "reset":
          b.manualOnly = !1, b.include = [], b.exclude = [];
      }
      I ? E() : q(), N(), f("content").scrollTop = y;
      return;
    }
    if (d?.id === "prev-page" && (g--, ee()), d?.id === "next-page" && (g++, ee()), d?.id === "show-markers" && (A = !A, d.textContent = A ? "● Знаки включены" : "○ Знаки выключены", d.setAttribute("aria-checked", String(A)), _()), d?.id === "bulk") {
      const v = f("bulk-state").value;
      for (const b of p.results) S.has(b.id) && (b.state = v);
      q(), ee(), ce(), J(), _();
    }
    if (d?.id === "capture-image") {
      const v = p.results.find((b) => b.id === h);
      if (v) {
        M = !1, F(!0), $("Создание снимка пары");
        try {
          v.image = await t.snapshot(
            ...
            () => M,
            !0
          ), v.imageScope = "pair-ab", q(), ce(), k("Снимок сохранён в результат.");
        } finally {
          Z(), F(!1);
        }
      }
    ...
    if (d?.id === "focus" && ne(h, !0), d?.id === "previous" || d?.id === "next") {
      const v = V(), b = v.findIndex((y) => y.id === h) + (d.id === "next" ? 1 : -1);
      v[b] && ne(v[b].id, !0);
    }
    if (d?.id === "export-html" || d?.id === "export-viewer") {
      let v = 0;
      const b = f("selected-only").checked ? p.results.filter((I) => S.has(I.id)) : p.results;
      if (!b.length) throw Error("Нет результатов для отчёта.");
      if (f("report-images").checked) {
        const I = t.view, O = I?.storeView();
          ...
          await t.captureWorkspace(async () => {
            ...
            for (const X of b) {
              ...
              if ($(
                ...
                P,
                b.length
              ), k("Подготовка снимков: " + (P + 1) + " / " + b.length), !X.image || X.imageScope !== "pair-ab") {
                if (X.state === "resolved" && !t.canLocate(X)) {
                  P++;
                  continue;
                }
                try {
                  X.image = await t.snapshot(
                    X,
                    Number(f("distance").value),
                    () => M
                  ), X.imageScope = "pair-ab", q();
                } catch (be) {
                  if (M || !t.isCurrent()) throw be;
                  v++;
                }
              }
              P++, $("Подготовка снимков отчёта", P, b.length);
            }
          });
        } finally {
          if (I && t.isCurrent()) {
            const P = p.results.find((X) => X.id === h);
            if (P)
              try {
                t.focus(
                  P,
    ...
    x && !l.closest("input") && !window.getSelection()?.toString() && ne(x.dataset.result);
  }), f("content").ondblclick = (s) => {
    const l = s.target, d = l.closest("[data-result]");
    d && !l.closest("input") && G(() => ne(d.dataset.result, !0));
  };
  const ot = setInterval(() => {
    w || (he() ? (f("model-count").textContent = "Модели не прочитаны", k(
...
async function jt(e) {
  await Ge(), e.repaint();
  const { candidates: t, rect: i } = nt(e), a = document.createElement("canvas");
  ...
  return document.body.append(a), async () => {
    e.repaint(), await Ge(), a.remove();
  };
}
async function Et(e, t) {
  if (await Ge(), t()) throw Error("Подготовка снимков отменена.");
  const { candidates: i } = nt(e), a = document.createElement("canvas"), r = Math.min(1, 1280 / i[0].width);
...
const Pe = "nashepo.checks.points", We = "nashepo.checks.highlight";
function Xe(e) {
...
function Ce(e, t, i, a = 0) {
  ...
  for (const [n, o] of Object.entries(r))
    n.startsWith("$") || Ce(o, t ? `${t}.${n}` : n, i, a + 1);
}
function At(e) {
  const t = e.vertices.length / 3, i = (o) => Number.isFinite(e.vertices[o * 3]) && Number.isFinite(e.vertices[o * 3 + 1]) && Number.isFinite(e.vertices[o * 3 + 2]), a = (o) => {
    const c = e.indices[o], u = e.indices[o + 1], m = e.indices[o + 2];
    return c < t && u < t && m < t && c !== u && u !== m && m !== c && i(c) && i(u) && i(m);
  };
  let r = 0;
  for (let o = 0; o < e.indices.length; o += 3) a(o) && (r += 3);
  if (r === e.indices.length) return e.indices;
  const n = new Uint32Array(r);
  for (let o = 0, c = 0; o < e.indices.length; o += 3)
    a(o) && (n[c++] = e.indices[o], n[c++] = e.indices[o + 1], n[c++] = e.indices[o + 2]);
  return n;
}
const qe = (e) => /\.wdx(?:[?#].*)?$/i.test(e);
class Ct {
  constructor(t) {
    this.ctx = t;
  }
  ...
  async scan(t, i, a) {
    ...
    const c = [], u = /* @__PURE__ */ new Set(), m = [], h = [], g = [], w = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Set();
    let j = 2166136261;
    const A = Xe(
    ...
    const S = (z) => {
      ...
      if (M.has(z)) return;
      M.add(z);
      const f = z.layers.layer0?.modelName || Y, B = Y, k = qe(f) || qe(B), $ = (E, L) => {
        u.has(E) || (u.add(E), c.push({ id: E, name: L }));
      };
      k || $(B, f);
      const Z = !k && (!a || a.has(B)), G = [];
      (Z || k) && z.layouts.model?.walk((E) => (E.type === Be.model3d ? G.push(E) : E.type === Be.insert && m.push(`${f}: вставка блока не включена в расчёт.`), !1));
      const pe = /* @__PURE__ */ new Map();
      for (const E of G) {
        let L = E.layer, U = "";
        for (; L; ) {
          if (L.modelName && !qe(L.modelName)) {
            U = L.modelName;
            break;
          }
          L = L.layer;
        }
        const V = k ? U || "Модель проекта" : f, J = k ? U || `${Y}/#model` : B;
        if (k && $(J, V), a && !a.has(J)) continue;
        const T = JSON.stringify([
          E.layer?.UUID || "",
          E.$id || E.$path
        ]);
        pe.set(JSON.stringify([J, T]), {
          key: T,
          objects: [E],
          modelId: J,
          modelName: V
      ...
      for (const E of pe.values()) {
        const { key: L, objects: U, modelId: V, modelName: J } = E;
        ...
        try {
          if (T) {
            ...
            let ne = T;
            for (; ne && _.length < 64; )
              _.unshift(ne), ne = ne.layer;
            for (const W of _)
              Ce(W.typedProperties(), "", N), W.typed?.name && (N.Тип = W.typed.name);
          }
        } catch {
          m.push(`${J} / ${L}: часть свойств недоступна.`);
        }
        const ee = N["ifc.id"] || Object.entries(N).find(
          ([_]) => /(^|\.)(globalid|ifcguid|guid)$/i.test(_)
        )?.[1] || "", ce = T?.name || U[0].$id || "Элемент", ae = JSON.stringify([V, L]);
        Object.assign(N, {
          Модель: J,
          Имя: ce,
          GUID: ee,
        ...
        for (const _ of U) {
          re &&= _.isClosed;
          for (const ne of Object.values(_.meshes)) {
            const W = ne.geometry;
            ...
            for (let F = 0; F < W.vertices.length; F += 3) {
              ...
              if (Math3d.mat4.mulv3(de, _.matrix, de), !de.every(Number.isFinite)) {
                ie = !0;
                continue;
              }
              for (let oe = 0; oe < 3; oe++)
                le.min[oe] = Math.min(le.min[oe], de[oe]), le.max[oe] = Math.max(le.max[oe], de[oe]);
              if (S(de.join(",")), F % 6e4 === 0 && (performance.now() - C > 200 && (C = performance.now(), t(
            ...
            for (let F = 0; F < W.indices.length; F += 3) {
              const de = W.indices[F], oe = W.indices[F + 1], xe = W.indices[F + 2];
              if (j = Math.imul(j ^ de, 16777619), j = Math.imul(j ^ oe, 16777619), j = Math.imul(j ^ xe, 16777619), de < Ie && oe < Ie && xe < Ie && de !== oe && oe !== xe && xe !== de && ke(de) && ke(oe) && ke(xe) ? se++ : ie = !0, F % 15e4 === 0 && (await A(), i()))
                throw Error("Чтение моделей отменено.");
            }
          }
        }
        ...
        S(JSON.stringify([ae, N, ue.hidden])), g.push(ue), w.set(ae, U);
      }
      q && m.push(
        `${f}: пропущено элементов без треугольной геометрии — ${q}.`
      );
      const he = [];
      ...
      for (const E of he) {
        const L = E.name || E.uri || E.$id, U = L || "Подключённая модель", V = `${Y}/${L || "attachment"}`;
        E.model || $(V, U), E.model ? await te(
          E.model,
          V,
          R || E.hidden
        ) : (!a || a.has(V)) && h.push(
    ...
    if (await te(o, o.layers.layer0?.modelName || "Проект", !1), !g.length && (!a || a.size > 0)) {
      const z = a ? [...a].filter((Y) => !u.has(Y)) : [];
      throw Error(
        z.length ? `Сохранённая выборка ссылается на модели, которых нет в текущем составе: ${z.join(", ")}. Обновите список моделей.` : c.length ? "В выбранных моделях не найдены 3D-элементы с доступной геометрией. Проверьте, что модели загружены, и выберите нужные файлы." : "В открытом проекте не обнаружены IFC/SMDX-модели. Проверьте состав подключений проекта."
      );
    }
    return this.clear(), this.refs = w, this.metadata = new Map(g.map((z) => [z.id, z])), this.scannedApp = r, this.scannedView = n, {
      ...
      blockers: [...new Set(h)],
      models: c,
      indexedModelIds: c.filter((z) => !a || a.has(z.id)).map((z) => z.id)
    };
  }
  async geometry(t, i) {
    ...
    for (const { g: M, indices: j } of o) {
      ...
      c += M.vertices.length, u += j.length;
    }
    const m = new Float64Array(c), h = new Uint32Array(u);
    let g = 0, w = 0;
    for (const { object: M, g: j, indices: A } of o) {
      ...
      for (let C = 0; C < A.length; C++)
        if (h[w + C] = g / 3 + A[C], C % 15e4 === 0 && (await a(), i()))
          throw Error("Чтение геометрии отменено.");
      g += j.vertices.length, w += A.length;
    }
    return { ...r, vertices: m, indices: h };
  }
  selected() {
    if (!this.isCurrent())
  ...
  clear() {
    if (this.overlay && (this.overlay.view.layer.removeLayer(this.overlay.layer), this.overlay.view.invalidate(), this.overlay = void 0, this.overlaySurfaces = []), this.pointView) {
      const t = this.pointView.annotations.get(Pe);
  ...
  focus(t, i, a = !0) {
    ...
    const o = [-0.65, 0.65, -0.394], c = Math.hypot(...o);
    o.forEach((u, m) => o[m] = u / c), n.lookAt(
      r.map((u, m) => u - o[m] * i),
      o,
      [0, 0, 1],
      a,
  ...
  highlight(t) {
    ...
    if (this.overlaySurfaces = a.flatMap(
      ({ id: o, color: c }, u) => [...new Set(this.refs.get(o) || [])].flatMap(
        (m) => Object.values(m.meshes).flatMap((h) => {
          const g = h.geometry;
          if (!g) return [];
          const w = {
            ...
            normals: g.normals,
            bounds: g.bounds,
            colors: new Uint32Array(g.vertices.length / 3).fill(c)
          };
          return [{ obj: m, geometry: w, color: c }];
        })
      )
    ), this.overlay) {
    ...
    r = {
      ...
      paint3d: (o) => {
        const c = o.color, u = o.rasterizer.material;
        o.rasterizer.material = void 0;
        try {
          for (const { obj: m, geometry: h, color: g } of this.overlaySurfaces) {
            o.color = g, o.pushMatrix();
            try {
              o.multMatrix(m.matrix), o.mesh(h);
            } finally {
              o.popMatrix();
            }
          }
          ...
          o.color = c, o.rasterizer.material = u;
        }
      },
      paintObject: () => {
      },
  ...
  async snapshotInWorkspace(t, i, a, r = !1) {
    ...
    const c = o.visible, u = n.annotations.visible, m = new Set(n.layer.selectedObjects());
    let h;
    try {
      r ? this.highlight(t) : this.focus(t, i, !1), n.pauseAnimation(), h = await jt(n), n.layer.clearSelected(), o.visible = !1, n.annotations.visible = !1, n.invalidate();
      const g = await Et(
        n,
        () => a() || !this.isCurrent()
      );
      ...
      o.visible = c, n.annotations.visible = u, n.layer.clearSelected(), n.layer.selectObjects((g) => m.has(g), !0), n.invalidate(), await h?.();
    }
  }
  markers(t, i, a, r) {
    ...
    const o = n.annotations.get(Pe);
    if (o && n.annotations.release(o), this.pointView = n, !a) {
      n.invalidate();
      return;
    }
    const c = n.annotations.create(Pe, 1e4), u = t.filter((m) => m.id !== i).concat(t.filter((m) => m.id === i));
    for (const m of u.slice(-3e3)) {
      if (m.state === "resolved") continue;
      const [h, g, w] = m.point, M = m.id === i, j = m.state === "excluded" ? "#78818c" : m.state === "approved" || m.state === "reviewed" ? "#28b94b" : "#e1372d", A = M ? "#f2c94c" : j, C = () => r(m.id), S = [
        { type: "line", a: [h, g, w], b: [h, g, w + 1], color: A, width: 5 },
        {
          type: "polyline",
          points: [
            [h - 0.65, g, w + 1],
...
const $t = {
  ...
  mount(e) {
    ...
    if (!t) return;
    if (Le && _e === e.manager) {
      t.replaceChildren(Le);
      return;
    }
    Ke?.();
    const i = document.createElement("div");
    i.style.height = "100%", t.replaceChildren(i), Le = i, _e = e.manager, Ke = It(i, new Ct(e));
  }
};
export {
  $t as default
